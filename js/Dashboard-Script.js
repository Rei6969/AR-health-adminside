document.addEventListener("DOMContentLoaded", () => {
  ...
  const containerAnnouncement = document.querySelector(
  ...
  const containerSchedule = document.querySelector(".schedule-container");
  ...
  function removeBtnStyle() {
    ...
    btnAnnouncement.style.removeProperty("background-color");
    btnAnnouncement.style.removeProperty("opacity");
    ...
    btnSchedule.style.removeProperty("background-color");
    btnSchedule.style.removeProperty("opacity");
    ...
    containerAnnouncement.style.display = "none";
  ...
  function handleSidebar() {
    ...
    } else if (currentSidebarBtn === "announcement") {
      btnAnnouncement.style.backgroundColor = "var(--color-sub-bg-4)";
      btnAnnouncement.style.opacity = "1";
      containerAnnouncement.style.display = "block";
    ...
    } else if (currentSidebarBtn === "schedule") {
      btnSchedule.style.backgroundColor = "var(--color-sub-bg-4)";
      btnSchedule.style.opacity = "1";
      containerSchedule.style.display = "block";
  ...
  btnAnnouncement.addEventListener("click", () => {
    sessionStorage.setItem("currentSidebarBtn", "announcement");
    handleSidebar();
  });
  ...
  btnSchedule.addEventListener("click", () => {
    sessionStorage.setItem("currentSidebarBtn", "schedule");
    handleSidebar();
  });
